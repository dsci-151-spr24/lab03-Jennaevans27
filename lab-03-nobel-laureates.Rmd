...
Yes the visualization does support Buzzfeed claim, as the data is showing that many were born in other countries.  
...
nobel_living_science %>% 
  ...
  arrange(desc(n))
```
***Germany is the most common with 20 followed closely by Japan and United Kingdom.*** 
